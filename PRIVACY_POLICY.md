## SCShowcase - BlurRecent: Privacy policy

Welcome to the SC app for Android!

This is an open source Android app developed by SC Group. The source code is available on GitHub under the GNU AGPL license (3.0 or later).
